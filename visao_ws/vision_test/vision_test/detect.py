...
class ballStatus(Node):
    ...
    # #===============================================================================
    #     ball = False
    #     frame_b, x, y, raio, ball, status = self.detect()
     ...
     # Load model
        ...
        for path, img, im0s, vid_cap in dataset:
            ...
            if len(det): # Entra nessa função se detectou a bola
                ...
                BallFound = True
                print("Primeiro valor do det: " + str(det[0][0].item()))
                xmed = det[0][0].item() + (det[0][1].item())/2
                print("XMED= " + str(det[0][1].item()) + "+" + str(det[0][0].item()) + "=" + str(xmed))
                x = det[0][0].item() 
                print("VALOR DO XXXXXXXXXXX: " + str(x))
